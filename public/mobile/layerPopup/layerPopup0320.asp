<!-- #include virtual = "/Modules/MDL.Common.asp" -->
<style>
body {overflow:visible;}
#layerPopupArea {display:block; position:fixed; _position:absolute; top:0; left:0; width:100%; height:100%; z-index:10000;} 
	#grayBg {position:absolute; top:0; left:0; width:100%; height:100%; background:#000 url("/images/layerPopupBg.png") 0 0; opacity:.7; filter:alpha(opacity=70);} 
...
<div id="layerPopupArea">
	...
	<div id="layerPopupAreaContents">
		<div id="layerPopupCloseBtn"><a href="#n" ><img src="/images/layerPopupCloseBtn.png"/></a></div>
		<div id="detailContents">
			...
			<style>
				.l0101 {}
					.l0101Wrap {width:630px; height:500px; overflow-y:auto;}
			</style>
			<div class="lContents l0101">
				<div class="lContentsWrap l0101Wrap">
					<!-- contents -->
					<span class="h1Font">[<%= mfCompany %> 귀하]</span>
					<br>
					이 대출상담신청과 관련하여 귀사가 본인으로부터 취득한 개인정보를 수집·이용하고자 하는 경우에는 『개인정보보호법』 제15조 및 제22조, 『정보통신망이용촉진 및 정보보호등에 관한 법률』제 22조에 따라 본인의 동의를 얻어야 합니다. 이에 본인은 귀사가 본인의 개인정보를 아래와 같이 수집·이용하는 것에 동의합니다.
					<br>
					<br>
					...
					· 개인식별정보(성명, 연락처 등)<br>
					③ 개인정보의 보유 및 이용기간 
					· 수집·이용 동의일로부터 개인정보의 수집·이용 목적을 달성할 때까지<br>
			...
			<!-- 상품설명 (모바일) -->
			<style>
				.lContents.lProductMobile {border:none; padding:0px;}
					.lContentsWrap.lProductMobileWrap {border:none!important; padding:0px!important; width:630px; overflow-y:auto;}
			</style>
			<div class="lContents lProductMobile">
				<div class="lContentsWrap lProductMobileWrap">
					<!-- contents -->
					<style>
						.table01 {width:100%; border-collapse:collapse; border:1px solid #66594e; border-left:none; border-top:none;}
							.table01 tbody tr th,
							.table01 tbody tr td {text-align:center; padding:10px 0; border:1px solid #66594e; border-right:none; border-bottom:none;}
							.table01 tbody tr th {background:#f0ede4; font-size:12px; color:#66594e;}
							.table01 tbody tr td {background:#ffffff; font-size:12px; color:#66594e; text-align:left;}
							.table01 thead tr th {background:#66594e; color:#fff; font-weight:700; font-size:14px; letter-spacing:-2px; border-left:1px solid #fff;  text-align:center; padding:10px 5%;}
							.table01 thead tr th:first-child {border:none;}
							.productTableMobile tbody tr th,
							.productTableMobile tbody tr td {padding:10px 5%;}
							.productTableMobile tbody tr th {width:25%;}
							.productTableMobile tbody tr td {width:65%;}
							.productTablePc tbody tr th,
							.productTablePc tbody tr td {text-align:center;}
					</style>
					<table class="table01 productTableMobile">
						<thead>
							<tr>
								<th colspan="2">상품안내</th>
							</tr>
						</thead>
						<tbody>
							<tr>
							...
							<tr>
								<th>대상고객</th>
								<td>4대보험 가입직장인 또는 급여통장 3개월이상 급여확인자</td>
							</tr>
							<tr>
								<th>연령</th>
								<td>만 20세 ~ 연령제한 없음</td>
							...
							<tr>
								<th>상환방식</th>
								<td>- 원리금균등상환<br>- 거치후 원리금 균등상환</td>
							</tr>
							<tr>
								<th>대출기간</th>
								<td>12,24,36,48,60개월 중 택1</td>
							</tr>
							<tr>
								<th>거치기간</th>
								<td>1,2,3,4,5,6개월 중 택1</td>
							</tr>
						</tbody>
					</table>
					<!-- end contents -->
			...
			<!-- 상품설명 (PC) -->
			<style>
				.lContents.lProductPc {border:none; padding:0px;}
					.lContentsWrap.lProductPcWrap {border:none!important; padding:0px!important; width:630px; overflow-y:auto;}
			</style>
			<div class="lContents lProductPc">
				<div class="lContentsWrap lProductPcWrap">
					<!-- contents -->
					<table class="table01 productTablePc">
						<colgroup>
							<col width="12%"></col>
							<col width="16%"></col>
							<col width="18%"></col>
						...
						<tbody>
							<tr>
								<th rowspan="9">자격요건</th>
								<td>대상고객</td>
								<td colspan="4">4대보험 가입직장인 또는 급여통장 3개월이상 급여확인자</td>
							</tr>
							<tr>
								<td>연령</td>
								<td colspan="4">만 20세 ~ 연령제한 없음</td>
							</tr>
							<tr>
								<td>취급지역</td>
								<td colspan="4">전국</td>
							...
							<tr>
								<td>상환방식</td>
								<td colspan="2">- 원리금 균등상환<br>- 거치 후 원리금균등 상환</td>
								<td>만기일시 상환</td>
								<td>- 원리금균등<br>- 거치후 원리금균등</td>
							</tr>
							<tr>
								<td>대출기간</td>
								<td colspan="4">12,24,36,48,60개월 중 택1</td>
							</tr>
							<tr>
								<td>거치기간</td>
								<td colspan="4">1,2,3,4,5,6개월 중 택1</td>
							</tr>
							<tr>
								<th rowspan="4">구비서류</th>
								<td>본인확인 서류</td>
								<td colspan="4">신분증 (주민등록증, 운전면허증 택1</td>
							</tr>
							<tr>
								<td rowspan="2">재직/소득 서류</td>
								<td colspan="2">4대보험 가입 Y</td>
								<td colspan="2">4대보험 가입 N</td>
							</tr>
							<tr>
								<td>건강보험 자격득실확인서</td>
								<td>건가보험 납부확인서</td>
							...
							<tr>
								<td>기타(선택) 서류</td>
								<td colspan="4">대출심사과정에서 필요시 주민등록원초본, 원천징수, 소득 금액증명원, 통장거래 내역 등</td>
							</tr>
						</tbody>
					</table>
					<!-- end contents -->
